...
import { faHome, faHeart, faAddressCard, faUserCog, faPowerOff, faQuestion } from '@fortawesome/free-solid-svg-icons';
...
function Sidebar(props) {
    return (   
        <div className="Sidebar_container w3-sidebar w3-bar-block w3-xxlarge">
            ...
            <Link to="/" className="w3-bar-item w3-button Sidebar_item"><FontAwesomeIcon icon={faHome} /><span className="Sidebar_item-name">Hm</span></Link> 
            ...
            <Link to="/quiz" className="w3-bar-item w3-button Sidebar_item"><FontAwesomeIcon icon={faQuestion} /><span className="Sidebar_item-name">Quizzzz</span></Link>
